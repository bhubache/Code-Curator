...
class SuccessiveFlattenListForRemove(LeafSubanimation):
    ...
    def begin(self):
        self._path = Line(start=self._start_node.next.get_container_left(), end=self._end_node.get_container_left())
    ...
    def clean_up_from_animation(self):
        ...
        self._sub_list_to_shift.align_to(self._path.point_from_proportion(smooth(0)), LEFT)
