...
from manim import VGroup, smooth, LEFT, Mobject, Line, Circle
...
class FlattenList(LeafSubanimation):
    ...
    def begin(self):
        ...
        self._container_path = Line(start=self._added_node_original_start, end=self._sll_post_subanimation_group[self._index].container.get_center())
